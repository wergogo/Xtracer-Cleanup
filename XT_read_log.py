...
class Log:
    def __init__(self):
        ...
        # Use workspace-relative tmp path
        self.per_int_path = os.path.join('tmp', 'permission_intent_header.csv')
        self.get_header()
...
if __name__ == '__main__':
    # Example usage:
    # target_path = [[os.path.join('apks', 'feature')], None]
    # get_dataset_sequence(os.path.join('dataset', 'dataset_sequence_5_479.csv'), 5)
    print('Run dataset functions from your own runner or notebooks. See functions: get_dataset_sequence, get_dataset_frequency.')